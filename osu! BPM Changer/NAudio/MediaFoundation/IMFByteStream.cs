...
namespace NAudio.MediaFoundation
{
    ...
    public interface IMFByteStream
    {
        ...
        ///     virtual HRESULT STDMETHODCALLTYPE Read(/*[size_is][out]*/ __RPC__out_ecount_full(cb) BYTE *pb, /*[in]*/ ULONG cb,
        ...
        ///     virtual /*[local]*/ HRESULT STDMETHODCALLTYPE BeginRead(/*[out]*/ _Out_writes_bytes_(cb)  BYTE *pb, /*[in]*/ ULONG
        ///     cb, /*[in]*/ IMFAsyncCallback *pCallback, /*[in]*/ IUnknown *punkState) = 0;
        /// </summary>
        void BeginRead(IntPtr pb, int cb, IntPtr pCallback, IntPtr punkState);

        /// <summary>
        ///     Completes an asynchronous read operation.
        ///     virtual /*[local]*/ HRESULT STDMETHODCALLTYPE EndRead(/*[in]*/ IMFAsyncResult *pResult, /*[out]*/ _Out_  ULONG
        ///     *pcbRead) = 0;
        /// </summary>
        ...
        ///     virtual HRESULT STDMETHODCALLTYPE Write(/*[size_is][in]*/ __RPC__in_ecount_full(cb) const BYTE *pb, /*[in]*/ ULONG
        ///     cb, /*[out]*/ __RPC__out ULONG *pcbWritten) = 0;
        /// </summary>
        void Write(IntPtr pb, int cb, ref int pcbWritten);

        /// <summary>
        ///     Begins an asynchronous write operation to the stream.
        ///     virtual /*[local]*/ HRESULT STDMETHODCALLTYPE BeginWrite(/*[in]*/ _In_reads_bytes_(cb)  const BYTE *pb, /*[in]*/
        ///     ULONG cb, /*[in]*/ IMFAsyncCallback *pCallback, /*[in]*/ IUnknown *punkState) = 0;
        /// </summary>
        void BeginWrite(IntPtr pb, int cb, IntPtr pCallback, IntPtr punkState);

        /// <summary>
        ///     Completes an asynchronous write operation.
        ///     virtual /*[local]*/ HRESULT STDMETHODCALLTYPE EndWrite(/*[in]*/ IMFAsyncResult *pResult, /*[out]*/ _Out_  ULONG
        ///     *pcbWritten) = 0;
        /// </summary>
        ...
        ///     virtual HRESULT STDMETHODCALLTYPE Seek(/*[in]*/ MFBYTESTREAM_SEEK_ORIGIN SeekOrigin, /*[in]*/ LONGLONG
        ///     llSeekOffset, /*[in]*/ DWORD dwSeekFlags, /*[out]*/ __RPC__out QWORD *pqwCurrentPosition) = 0;
        /// </summary>
