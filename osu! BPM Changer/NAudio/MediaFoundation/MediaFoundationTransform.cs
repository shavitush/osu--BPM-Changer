    ...
    public abstract class MediaFoundationTransform : IWaveProvider, IDisposable
    {
        ...
        public MediaFoundationTransform(IWaveProvider sourceProvider, WaveFormat outputFormat)
        {
            ...
            outputBuffer = new byte[outputWaveFormat.AverageBytesPerSecond + outputWaveFormat.BlockAlign];
                // we will grow this buffer if needed, but try to make something big enough
        }
        ...
        public int Read(byte[] buffer, int offset, int count)
        {
            ...
            {
                IMFSample sample = ReadFromSource();
        ...
        private int ReadFromTransform()
        {
            ...
            IMFMediaBuffer pBuffer = MediaFoundationApi.CreateMemoryBuffer(outputBuffer.Length);
            ...
            int hr = transform.ProcessOutput(_MFT_PROCESS_OUTPUT_FLAGS.None,
        ...
        private IMFSample ReadFromSource()
        {
            ...
            IMFMediaBuffer mediaBuffer = MediaFoundationApi.CreateMemoryBuffer(bytesRead);
            IntPtr pBuffer;
