...
namespace NAudio.MediaFoundation
{
    ...
    public interface IMFMediaType : IMFAttributes
    {
        ...
        /// </summary>
        void GetRepresentation([In, MarshalAs(UnmanagedType.Struct)] Guid guidRepresentation,
            ref IntPtr ppvRepresentation);

        /// <summary>
        ///     Frees memory that was allocated by the GetRepresentation method.
        /// </summary>
        void FreeRepresentation([In, MarshalAs(UnmanagedType.Struct)] Guid guidRepresentation,
