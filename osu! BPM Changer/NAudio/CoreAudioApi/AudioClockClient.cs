    ...
    public class AudioClockClient : IDisposable
    {
        ...
        public ulong AdjustedPosition
        {
            get
            {
                ...
                ulong byteLatency = (TimeSpan.TicksPerSecond/Frequency);
                ...
                if (Stopwatch.IsHighResolution)
                {
                    ...
                    ulong qposDiff = (qposNow - qpos)/100;

                    // find out how many byte would have played in that time span
                    ulong bytes = qposDiff/byteLatency;
        ...
        {
            int hr = audioClockClientInterface.GetPosition(out position, out qpcPosition);
