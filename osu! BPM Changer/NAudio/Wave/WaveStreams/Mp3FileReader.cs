...
namespace NAudio.Wave
{
    ...
    public class Mp3FileReader : WaveStream
    {
        ...
        public Mp3FileReader(Stream inputStream, FrameDecompressorBuilder frameDecompressorBuilder)
        {
            ...
            Mp3Frame firstFrame = Mp3Frame.LoadFromStream(mp3Stream);
            ...
            Mp3Frame secondFrame = Mp3Frame.LoadFromStream(mp3Stream);
            if (secondFrame != null &&
            ...
            Mp3WaveFormat = new Mp3WaveFormat(firstFrame.SampleRate, firstFrame.ChannelMode == ChannelMode.Mono ? 1 : 2,
