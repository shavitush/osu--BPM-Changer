...
namespace NAudio.Wave
{
    ...
    internal static class WaveCapabilitiesHelpers
    {
        ...
        public static string GetNameFromGuid(Guid guid)
        {
            ...
            string name = null;
            using (
                RegistryKey namesKey =
                    Registry.LocalMachine.OpenSubKey(@"System\CurrentControlSet\Control\MediaCategories"))
            using (RegistryKey nameKey = namesKey.OpenSubKey(guid.ToString("B")))
            {
