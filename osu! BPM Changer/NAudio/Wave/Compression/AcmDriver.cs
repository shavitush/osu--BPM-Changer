...
namespace NAudio.Wave.Compression
{
    ...
    public class AcmDriver : IDisposable
    {
        ...
        public static AcmDriver AddLocalDriver(string driverFile)
        {
            ...
            IntPtr driverProc = NativeMethods.GetProcAddress(handle, "DriverProc");
            ...
            IntPtr driverHandle;
            MmResult result = AcmInterop.acmDriverAdd(out driverHandle,
        ...
        public static void RemoveLocalDriver(AcmDriver localDriver)
        {
            ...
            MmResult removeResult = AcmInterop.acmDriverRemove(localDriver.driverId, 0); // gets stored as a driver Id
